			...
			<table class="table table-striped table-bordered">
				...
				<tr>
					...
					<td><form:input path="boWriter"
						...
						<!-- 			<input type="text" name="boWriter" value="${freeBoard.boWriter}"  class="form-control input-sm" required="required" ></td> -->
				</tr>
				<tr>
					<th>비밀번호</th>
					<td><form:password path="boPass"
							cssClass="form-control input-sm" /> <form:errors path="boPass"></form:errors>
				...
				<tr>
					...
					<td><form:textarea path="boContent" cssClass="form-control"
							rows="10" /> <form:errors path="boContent"></form:errors></td>
				</tr>
				<tr>
					<th>첨부파일
