...
<!-- 						작성자도 바꿀수 없지 -->
					...
					<tr>
						<th>내용</th>
						<td><textarea rws="10" name="boContent" class="form-control input-sm">${freeBoard.boContent }</textarea></td>
					</tr>
					<tr>
						<th>IP</th>
					...
					<tr>
						<th>최근등록일자</th>
						<td>${freeBoard.boRegDate eq null ? freeBoard.boRegDatd : freeBoard.boModDate  }</td>
					</tr>
					<tr>
						<td colspan="2">
							<div class="pull-left">
