...
public class MemberController {
	...
	// 1. codeService로 얻는 코드는 @ModelAttribute()메소드로 만들것 
	// 2. VO에는 @ModelAttribute() 붙여준다.
	...
	public String memberModify(Model model,@Validated(value = {Modify.class}) @ModelAttribute("member")MemberVO member, BindingResult error) {
