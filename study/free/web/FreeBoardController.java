...
//			req.setAttribute("freeBoard", freeBoard);
	...
	public String freeBoardModify(Model model,@Validated(value = {Modify.class, Default.class}) @ModelAttribute("freeBoard") FreeBoardVO freeBoard, BindingResult error,
		...
		System.out.println("boFiles: " + boFiles);
		System.out.println("boFilesLength: " + boFiles.length);
		if(boFiles != null) {
	...
	public String freeBoardRegist(Model model,@Validated()@ModelAttribute("freeBoard") FreeBoardVO freeBoard, BindingResult error,@RequestParam(required = false) MultipartFile[] boFiles ) throws IOException {
		...
		// files 
		System.out.println("BOARDREGISE"+ boFiles);
