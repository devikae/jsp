...
public class PagingVO implements Serializable {
	...
	public void pageSetting() {
		// curPage = 13 totalRowCount= 338
//		firstRow = (curPage-1) * (rowSizePerPage+1); // 121
//		lastRow = (totalPageCount * pageSize)  + (totalRowCount % rowSizePerPage); // 마지막 글 번호 140 +   
//		totalPageCount = (pageSize *rowSizePerPage) / totalRowCount ;  // 페이지가 몇개 나오는지
//		firstPage = totalRowCount 
//		lastPage = 	
