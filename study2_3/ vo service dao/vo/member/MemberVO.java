...
public class MemberVO {
	...
	private String jobCategory;				  /* 직업카테고리 */
	private String hobCategory;				  /* 취미카테고리 */
	...
	public String getHobCategory() {
		return hobCategory;
	}


	public void setHobCategory(String hobCategory) {
		this.hobCategory = hobCategory;
	}
