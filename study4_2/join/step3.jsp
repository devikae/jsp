		...
		<div class="row col-md-8 col-md-offset-2">
			...
			<table class="table">
				...
				<tr class="form-group-sm">
					<th>생일</th>
					<td>
						<input type="date" value="${member.memBir }" class="form-control input-sm" name="memBir">
...
<!-- 							form select써서 <select name="memJob" class="form-control"></select> -->
...
<!-- 						form select써서 <select name="memLike" class="form-control"></select> -->
				...
				<tr>
					<td colspan="2">
						<div class="pull-left">
							<a href="${pageContext.request.contextPath}/join/cancel.wow" class="btn btn-sm btn-default"> <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> &nbsp;&nbsp;취 소
							</a>
						</div>
